    ...
    <>
      ...
      <div className="max-w-7xl mx-auto my-10">
        ...
        <div className="flex items-center justify-between">
          ...
          <Button
            disabled={isApplied}
            className={`rounded-lg ${isApplied ? 'bg-gray-600 cursor-not-allowed text-white hover:bg-gray-600 ' :
              'bg-[#6A38C2] hover:bg-[black] text-white hover:text-white rounded-[10px]'}`}>{isApplied ? "Already Applied" : 'Apply Now'}
          </Button>
        </div>

        <h1 className="border-b-2 border-b-gray-300 font-medium py-4">Jobs Description</h1>
        ...
        <div className="my-4">
          ...
          <h1 className="font-bold my-1">Total Applicatts: <span className="pl-4 font-normal text-gray-800">4</span></h1>
