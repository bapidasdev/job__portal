    ...
    return (
        <div className="text-center">
            <div className="flex flex-col gap-5 my-10">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur eos illo commodi quia exercitationem ex.</p>
                <div className="flex w-[40%] shadow-lg border border-gray-200 pl-3 rounded-full items-center gap-4 mx-auto">
                    <input type="text" placeholder="Find your dream jobs" className="outline-none border-none w-full" />
                    <Button className="rounded-r-full bg-[#6A38C2] text-white hover:bg-[black]">
